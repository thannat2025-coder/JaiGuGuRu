      ...
      >
        <div className="bg-indigo-600 p-8 text-white relative">
          ...
          <p className="text-indigo-100 text-sm leading-relaxed opacity-90">
            Jai-Gu (ใจกุ) ให้ความสำคัญสูงสุดกับความลับและข้อมูลส่วนตัวของคุณ เพื่อให้คุณเปลาะบางและเปิดใจได้อย่างสบายใจที่สุด
          </p>
        </div>
        ...
        <div className="p-8 space-y-6">
          <ul className="space-y-4">
            ...
            <PrivacyItem 
              ...
              desc="ลิขสิทธิ์แอปพลิเคชันและการออกแบบเป็นของ นพ.ธันวรุจน์ บูรณสุขสกุล ห้ามลอกเลียนแบบ ดัดแปลง หรือทำซ้ำ ให้ใช้ซอฟต์แวร์นี้เพื่อเยียวยาและเป็นประโยชน์ต่อผู้ที่กำลังเผชิญเหตุและทุกข์ใจเท่านั้นครับ"
            />
          </ul>
